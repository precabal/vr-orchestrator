...
namespace AssemblyCSharp
{
	public class Hihat_1 : IInstrument
	{
		...
		public Hihat_1 ()
		{
			...
			//surrounding objects:
			_objects.AddRange( ObjectFactory.InitializeRandomPrefabsInSphere(ObjectFactory.sphere, _centerPosition) );
			...
			GameObject mainObject = ObjectFactory.CreateFromPrefab(ObjectFactory.soundSource, _centerPosition, "hihat_1");
